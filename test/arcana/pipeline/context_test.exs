defmodule Arcana.Pipeline.ContextTest do
  ...
  describe "new/2" do
    test "creates context with required options" do
      ctx = Pipeline.new("What is Elixir?", repo: Arcana.TestRepo, llm: &mock_llm/1)
    ...
    test "sets default limit and threshold" do
      ctx = Pipeline.new("test", repo: Arcana.TestRepo, llm: &mock_llm/1)
    ...
    test "explicit options override config defaults" do
      ...
      ctx = Pipeline.new("test", llm: custom_llm)
